...
@section('active-main-menu-school', 'opened')
@section('title')
	សាលាបណ្តុះបណ្តាល: @yield('section-title')
@endsection
	...
	<header class="page-content-header">
		<div class="container-fluid">
			<div class="tbl">
				<div class="tbl-row">
					<div class="tbl-cell">
						<h3>សាលាបណ្តុះបណ្តាល <span> <i class="fa fa-long-arrow-right"></i> @yield('section-title')</span></h3> 
					</div>
