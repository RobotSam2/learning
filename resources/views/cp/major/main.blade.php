...
@section('active-main-menu-major', 'opened')
@section('title')
	មុខវិជ្ជាឯកទេស: @yield('section-title')
@endsection
	...
	<header class="page-content-header">
		<div class="container-fluid">
			<div class="tbl">
				<div class="tbl-row">
					<div class="tbl-cell">
						<h3>មុខវិជ្ជាឯកទេស <span> <i class="fa fa-long-arrow-right"></i> @yield('section-title')</span></h3> 
					</div>
