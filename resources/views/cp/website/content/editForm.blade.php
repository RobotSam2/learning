...
@section('active-main-menu-message', 'opened')
				...
				<div class="container-fluid">
					...
					<form id="form" action="{{ route($route.'.update') }}?" name="form" method="POST"  enctype="multipart/form-data">
						...
						<div class="form-group row">
							<label class="col-sm-2 form-control-label" for="content">Message</label>
							<div class="col-sm-10">
								<div class="summernote-theme-1">
									<textarea id="content" name="content" class="form-control @if($data->editor_required) summernote @endif "> {{ $data->content }}</textarea>
								</div>	
							</div>
						</div>
