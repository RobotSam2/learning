...
@section('active-main-menu-maincate', 'opened')
@section('title')
	ប្រភេទផលិតផលដំបូង: @yield('section-title')
@endsection
	...
	<header class="page-content-header">
		<div class="container-fluid">
			<div class="tbl">
				<div class="tbl-row">
					<div class="tbl-cell">
						<h3>ប្រភេទផលិតផលដំបូង <span> <i class="fa fa-long-arrow-right"></i> @yield('section-title')</span></h3> 
					</div>
